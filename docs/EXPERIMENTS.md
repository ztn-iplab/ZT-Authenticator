...
Add `--insecure` if you are using a self-signed TLS cert locally.
...
```bash
python scripts/collect_frr_sweep.py --base-url https://localhost:8000 --trials 30 --drifts 0,15,30,60,90,120 --output experiments/frr_sweep.csv
```
